        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoProceso = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    MateriaPrimaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductosEnProceso", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductosEnProceso_MateriasPrimas_MateriaPrimaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                    ProductoEnProcesoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductoTerminado", x => x.ProductoTerminadoId);
                    table.ForeignKey(
                        name: "FK_ProductoTerminado_ProductosEnProceso_ProductoEnProcesoId",
                        column: x => x.ProductoEnProcesoId,
                        principalTable: "ProductosEnProceso",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolSolicitadoId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Solicitudes_Roles_RolSolicitadoId",
                        column: x => x.RolSolicitadoId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Solicitudes_Usuarios_UsuarioAfectadoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductosEnProceso_MateriaPrimaId",
                table: "ProductosEnProceso",
                column: "MateriaPrimaId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductoTerminado_ProductoEnProcesoId",
                table: "ProductoTerminado",
                column: "ProductoEnProcesoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solicitudes_RolSolicitadoId",
                table: "Solicitudes",
                column: "RolSolicitadoId");

            migrationBuilder.CreateIndex(
                name: "IX_Solicitudes_UsuarioAfectadoId",
                table: "Solicitudes",
